...
class ServoConection:
    ...
    def servoConfig(self, id):
        ...
        servo.sdo_write(index=0x1C12, subindex=0, data=0, ca=True)
        servo.sdo_write(index=0x1C13, subindex=0, data=0, ca=True)

        servo.sdo_write(index=0x1600, subindex=0, data=0, ca=True)
        servo.sdo_write(index=0x1601, subindex=0, data=0, ca=True)
        servo.sdo_write(index=0x1602, subindex=0, data=0, ca=True)
        servo.sdo_write(index=0x1603, subindex=0, data=0, ca=True)
        servo.sdo_write(index=0x1A00, subindex=0, data=0, ca=True)
        servo.sdo_write(index=0x1A01, subindex=0, data=0, ca=True)
        servo.sdo_write(index=0x1A02, subindex=0, data=0, ca=True)
        servo.sdo_write(index=0x1A03, subindex=0, data=0, ca=True)
